...
class Attention(nn.Module):
    ...
    def forward(self, x, cnt, signal, T):
        ...
        if signal == 1:
          ...
          np.savez('/home/qichunyu/TimeSformer/frame_similarity/query' + str(cnt), q_tmp.cpu().detach().numpy())
        ######
        ...
        if signal == 1:
          ...
          np.savez('/home/qichunyu/TimeSformer/frame_similarity/attn' + str(cnt), attn_tmp.cpu().detach().numpy())
        ######
...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        # np.savez('/home/qichunyu/TimeSformer/frame_similarity/block' + str(self.cnt), x.cpu().detach().numpy())
        # x = rearrange(x, 'b n t m -> b (n t) m',t=T)
